...
ensureEvent(combat, "WhiffEvent")
ensureEvent(combat, "BlockImpactEvent")
ensureEvent(combat, "StunChangedEvent")
...
ensureEvent(combat, "AntiMannerKickCourseStart")
ensureEvent(combat, "AntiMannerKickCourseHit")
...
ensureEvent(combat, "RokuganStart")
ensureEvent(combat, "RokuganHit")
